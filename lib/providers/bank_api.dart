...
// import 'package:itaxeasy/models/bank/upi_verification.dart';

// import '../data/response/api_response.dart';
// import '../data/respository/auth_repository.dart';
// import '../data/utils/utils.dart';
// import '../models/bank/bank_vakidation.dart';
// import '../models/bank/ifcs_validation.dart';
// import '../screens/services/bank/ifce_code_view.dart';
...
//     notifyListeners();
//   }
//   Future<void> IFCSValidationProvider(dynamic data,BuildContext context )
//   async{
//     setLoading(true);

//     print('hello i am ');
//     _myRepo.IfcsValidationRepository(data).then((value){
//       Navigator.push(context,MaterialPageRoute(builder: (context)=>const IfceDetailView()));
...
//     notifyListeners();
//   }
//   Future<void> BankValidationProvider(dynamic data,BuildContext context ) async{
