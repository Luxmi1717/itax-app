...
//
//     final businessLoanCalc = businessLoanCalcFromJson(jsonString);

import 'dart:convert';

BusinessLoanCalc businessLoanCalcFromJson(String str) =>
    BusinessLoanCalc.fromJson(json.decode(str));

String businessLoanCalcToJson(BusinessLoanCalc data) =>
    json.encode(data.toJson());

class BusinessLoanCalc {
  BusinessLoanCalc({
    this.success,
    this.results,
  });
  ...
  factory BusinessLoanCalc.fromJson(Map<String, dynamic> json) =>
      BusinessLoanCalc(
