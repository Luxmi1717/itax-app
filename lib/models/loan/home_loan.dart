...
//
//     final homeLoanCalc = homeLoanCalcFromJson(jsonString);

import 'dart:convert';

HomeLoanCalc homeLoanCalcFromJson(String str) =>
    HomeLoanCalc.fromJson(json.decode(str));

String homeLoanCalcToJson(HomeLoanCalc data) => json.encode(data.toJson());
...
class HomeLoanCalc {
  ...
  factory HomeLoanCalc.fromJson(Map<String, dynamic> json) => HomeLoanCalc(
