...
class Data {
  ...
  Data({
    required this.companyMasterData,
    required this.charges,
    required this.directorsSignatoryDetails,
  });
...
class CompanyMasterData {
  ...
  CompanyMasterData({
    ...
    required this.classOfCompany,
    required this.numberOfMembersApplicableInCaseOfCompanyWithoutShareCapital,
    required this.addressOtherThanROWhereAllOrAnyBooksOfAccountAndPapersAreMaintained,
    required this.dateOfLastAgm,
    required this.registeredAddress,
    required this.activeCompliance,
    required this.registrationNumber,
    required this.paidUpCapitalRs,
    required this.whetherListedOrNot,
    required this.suspendedAtStockExchange,
    required this.companySubcategory,
    required this.authorisedCapitalRs,
    required this.companyStatusForEfiling,
    required this.rocCode,
    required this.dateOfBalanceSheet,
...
class DirectorsSignatoryDetail {
  ...
  DirectorsSignatoryDetail({
    ...
    required this.surrenderedDin,
    required this.dinPan,
