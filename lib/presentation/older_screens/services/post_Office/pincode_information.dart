...
import '../../bill_shill/bill/pdfview/pdf_view_screen.dart';
import '../pdf_service.dart';


class PineCodeInformationPage extends StatefulWidget {
  const PineCodeInformationPage({super.key});

  @override
  State<PineCodeInformationPage> createState() => _PineCodeInformationPageState();
}

class _PineCodeInformationPageState extends State<PineCodeInformationPage> {
  ...
  Widget build(BuildContext context) {
    return
      Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<PincodeByInfo>(builder: (BuildContext context, pro, child) {
                    ...
                    onTap: () {
                      bool isValid = validateGSTIN(PinCode.text);
                      {
                        if (isValid) {
                          ...
                          pro.PincodeByInfoProv(PinCode.text, context);
                ...
                Consumer<PincodeByInfo>(builder: (BuildContext context, result, child) {
                              ...
                              child: Card(
                                child: Column(children: [
                                  DataTable(
                                      ...
                                      rows: result.PincodeByInfoDetails.data!.data.map((e) {
        ...
        floatingActionButton: Consumer<PincodeByInfo>(builder: (BuildContext context, result, child) {
          return Visibility(
            visible: result.visible,
  ...
  Future<File> generatePDF(BuildContext context) async {
    ...
    final result = Provider.of<PincodeByInfo>(context, listen: false);
    ...
    List<List<dynamic>> tableData = result.PincodeByInfoDetails.data!.data.map((e) => [
        ...
        build: (context) => pw.Column(
          children: [
            ...
            pw.Text(
              ...
              ' Pin Information DETAILS', // Replace with your company name
              style: pw.TextStyle(
...
PreferredSizeWidget _buildAppBar(BuildContext context) {
  return CustomAppBar(
    ...
    centerTitle: true,
    title: AppbarTitle(
      text: "Pin Code Information details",
    ),
  );
}