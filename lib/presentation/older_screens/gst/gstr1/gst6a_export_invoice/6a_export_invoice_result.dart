...
import 'model_list_record.dart';

class Gst6a_export_Result extends StatefulWidget {
  final BusinessProfile data;

  const Gst6a_export_Result({super.key, required this.data, });

  @override
  State<Gst6a_export_Result> createState() => _Gst6a_export_ResultState();
}

class _Gst6a_export_ResultState extends State<Gst6a_export_Result> {
                      ...
                      SizedBox(
                        ...
                        child: Consumer<RatePercentCalculation>(builder: (BuildContext context ,data ,child ,) {
                          ...
                          rows: [
                            ...
                            DataRow(
                              cells: [
                                const DataCell(Text('Invoice data',style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,),)),
                                DataCell(TextField(
                            ...
                            DataRow(
                              cells: [
                                const DataCell(Text('Total invoice val ',style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,),)),
                                DataCell(TextField(
                    ...
                    Consumer<RecordProvider>(
                        builder: (context, datalistpro, child) {
                          return CustomButton(onTap: () {
                            ...
                            datalistpro.addRecord6a_export(Gst6aModel(
                                Invoice_no: InvoicNO.text, Invoice_data: InvoicDate.text, Total_invoice: TotalInvoiceValue.text, Integrate_tax:gstCal.cgsttotal.text, Total_taxable: gstCal.TotalTurnover.toString(), cess: gstCal.cgsttotal.text, GSTPayment: GSTPayment.text,));
