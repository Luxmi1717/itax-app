...
import '../../../../../providers/providers_old/rate_percent_calculation.dart';
import '8a_8c_model_page.dart';



class Gst8a_8b_8c_8d_Result extends StatefulWidget {
  final BusinessProfile data;
  const Gst8a_8b_8c_8d_Result({super.key, required this.data, });

  @override
  State<Gst8a_8b_8c_8d_Result> createState() => _Gst8a_8b_8c_8d_ResultState();
}

class _Gst8a_8b_8c_8d_ResultState extends State<Gst8a_8b_8c_8d_Result> {
                    ...
                    Consumer<RecordProvider>(
                        builder: (context, datalistpro, child) {
                          return CustomButton(onTap: () {
                            datalistpro.addRecord8a_8b_8c_8d(Model8a_8b_8c_8d(Place_of_supply: '', Rate: '', Total_taxable: '', Integrated: '', central_tax: '', State_tax: '', cess: ''
                              ));
