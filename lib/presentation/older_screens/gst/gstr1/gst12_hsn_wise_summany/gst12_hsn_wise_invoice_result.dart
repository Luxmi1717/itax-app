...
import 'gst12_hsn_wise_model_page.dart';
                    ...
                    Consumer<RecordProvider>(
                        builder: (context, datalistpro, child) {
                          return CustomButton(onTap: () {
                            datalistpro.addRecordgst12_hsn_wise(Modelgst12_hsn_wise(Place_of_supply: '', Rate: '', Total_taxable: '', Integrated: '', central_tax: '', State_tax: '', cess: ''
                              ));
